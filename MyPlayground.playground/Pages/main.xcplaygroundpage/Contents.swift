...
*/
func isForceWith(firstString: String) -> Bool
{
    if firstString == "Luke" || firstString == "Leia" || firstString == "Anakin" || firstString == "Obi Wan" || firstString == "Yoda" || firstString == "Vader" {
        return true
    } else {
        return false
    }
